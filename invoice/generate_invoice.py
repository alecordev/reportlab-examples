...
# TODO: file path should be None default, to return as buffer
def generate_commercial_invoice(
    ...
    flags,
    importer_data=None,
    file_path="output_commercial_invoice.pdf",
    ...
    styles.add(
        ParagraphStyle(name="Line_Data", alignment=TA_LEFT, fontSize=8, leading=7)
    )
    styles.add(
        ParagraphStyle(name="Line_Data_Small", alignment=TA_LEFT, fontSize=7, leading=8)
    )
    styles.add(
        ParagraphStyle(
    ...
    company_address = "{0}<br />{1}, {2}<br />{3} {4}".format(
        export_data["address"],
        export_data["city"],
    ...
    data1 = [
        [
            Paragraph("INTERNATIONAL<br /> AIR WAYBILL NO.", styles["Line_Label"]),
            Paragraph(export_data["waybill_no"], styles["Line_Data_Largest"]),
            Paragraph(
                "<b>NOTE: ALl shipments must be <br /> "
                "accompanied by a Fedex Express <br /> "
                "international Air Waybill.</b>",
                styles["Line_Data_Small"],
            ),
        ]
    ]
    ...
    data1 = [
        [
            Paragraph("DATE OF EXPORTATION", styles["Line_Label"]),
            Paragraph(
                "EXPORT REFERENCES (i.e. order no., invoice no.)", styles["Line_Label"]
            ),
        ],
        [
    ...
    data1 = [
        [
            Paragraph(
                "SHIPPER/EXPORTER (complete name and address)", styles["Line_Label"]
            ),
    ...
    data1 = [
        [
            Paragraph("COUNTRY OF EXPORT", styles["Line_Label"]),
            Paragraph(
                "IMPORTER -- IF OTHER THAN CONSIGNEE <br />(complete name and address)",
                styles["Line_Label"],
            ),
        ],
        [
    ...
    data1 = [
        [
            Paragraph("MARKS/NOS.", styles["Line_Label"]),
    ...
    data1 = [
        [
            Paragraph(str(product["marks_nos"]), styles["Line_Data"]),
            ...
            Paragraph(str(product["total_value"]), styles["Line_Data"]),
        ]
    ...
    data1 = [
        ...
        [
            ...
            Paragraph(
                "SEE http://www.fedex.com FOR MORE INFORMATION ON THE CORPORATE INVOICE.",
    ...
    t1 = Table(
        data1, colWidths=(1.7 * cm, 1.3 * cm, 11.5 * cm, 1.5 * cm, 1.8 * cm, 1.8 * cm)
    )
    t1.setStyle(
        TableStyle(
            [
    ...
    checked_image_path = os.path.join(current_directory, "checked.png")
    unchecked_image_path = os.path.join(current_directory, "unchecked.png")
    ...
    check_data = [
        [Paragraph("Check one", styles["Line_Label"]), ""],
        [
            Image(flag_image_paths["fob"], 0.25 * cm, 0.25 * cm),
            Paragraph("F.O.B.", styles["Line_Label"]),
        ],
        [
            Image(flag_image_paths["caf"], 0.25 * cm, 0.25 * cm),
            Paragraph("C & F", styles["Line_Label"]),
        ],
        [
            Image(flag_image_paths["cif"], 0.25 * cm, 0.25 * cm),
            Paragraph("C.I.F.", styles["Line_Label"]),
        ],
    ]
    tc = Table(check_data, colWidths=(0.4 * cm, None))
    tc.setStyle(
        TableStyle(
            [
                ("VALIGN", (0, 0), (-1, -1), "MIDDLE"),
            ...
            [
                [
                    Paragraph(
                        ...
                        "INVOICE TO BE TRUE AND CORRECT",
                        styles["Line_Label"],
                    )
                ]
            ]
...
export_data = {
    ...
    "postal_code": "L8J 1V4",
    "country_code": "CA",
    "waybill_no": "9999 9999 9999",
    "export_date": "12/20/2015",
    "export_refs": "999432423, 14314321423",
    "export_country": "USA",
...
product1 = {
    ...
    "no_packages": 1,
    "package_type": "BOX",
    "description": "a description of the goods in a full and up to date way",
    "quantity": 1,
    "measure_unit": "lbs",
    "weight": 25,
    "unit_value": 23.24,
...
product2 = {
    "marks_nos": "12",
    "no_packages": 1,
    "package_type": "OWN_PACKAGING",
    "description": "a description of the goods, another product to describe",
    "quantity": 2,
    "measure_unit": "lbs",
    "weight": 5,
    "unit_value": 43.44,
...
generate_commercial_invoice(
    export_data, exporter_data, cosignee_data, products, flags, importer_data
)
